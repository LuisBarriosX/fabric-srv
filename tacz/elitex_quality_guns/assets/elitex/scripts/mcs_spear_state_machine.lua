...
local function runReloadAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_empty_ext_1", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2 or ext == 3) then
            context:runAnimation("reload_empty_ext_2", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("reload_empty", track, false, PLAY_ONCE_STOP, 0.2)
        end
    else
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_ext_1", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2 or ext == 3) then
            context:runAnimation("reload_ext_2", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("reload_tactical", track, false, PLAY_ONCE_STOP, 0.2)
        end
    end
