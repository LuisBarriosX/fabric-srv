...
local function runReloadAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_extended_mag_empty", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2) then
            context:runAnimation("reload_extended_mag_empty", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 3) then
            context:runAnimation("reload_extended_mag_2_empty", track, false, PLAY_ONCE_STOP, 0.2)
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_extended_mag", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2) then
           context:runAnimation("reload_extended_mag", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 3) then
           context:runAnimation("reload_extended_mag_2_normal", track, false, PLAY_ONCE_STOP, 0.2)
