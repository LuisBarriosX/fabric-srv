...
local function runReloadAnimation(context)
    ...
    if (isNoAmmo(context)) then
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_extended_empty_1", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2) then
            context:runAnimation("reload_extended_empty_2", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 3) then
            context:runAnimation("reload_extended_empty_2", track, false, PLAY_ONCE_STOP, 0.2)
        ...
        elseif (ext == 1) then
            context:runAnimation("reload_extended_1", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 2) then
           context:runAnimation("reload_extended_2", track, false, PLAY_ONCE_STOP, 0.2)
        elseif (ext == 3) then
           context:runAnimation("reload_extended_2", track, false, PLAY_ONCE_STOP, 0.2)
        else
            context:runAnimation("reload_tactical", track, false, PLAY_ONCE_STOP, 0.2)
